...
></div>
        ...
        <div className="container py-lg-11">
          ...
          <nav className="side-menu-float position-fixed top-50 translate-middle-y ms-2">
            ...
            <ul className="nav flex-lg-column side-menu gap-2 py-2 py-lg-0">
              <li className="nav-item">
                <a className="nav-link d-flex align-items-center active" aria-current="page" href="#">精選甜點</a>
              </li>
              <li className="nav-item">
                <a className="nav-link d-flex align-items-center" href="#">季節限定</a>
              </li>
              <li className="nav-item">
                <a className="nav-link d-flex align-items-center" href="#">在地甜點</a>
              </li>
              <li className="nav-item">
                <a className="nav-link d-flex align-items-center" href="#">異國風味</a>
              </li>
              <li className="nav-item">
                <a className="nav-link d-flex align-items-center" href="#">無負擔甜點</a>
              </li>
              <li className="nav-item">
                <a className="nav-link d-flex align-items-center" href="#">素食甜點</a>
              </li>
            </ul>
          </nav>
          <div className="row">
            ...
            <div className="col-xl-4 col-lg-5 plan-opts mb-17 mb-lg-11 pt-6 pt-lg-4 px-lg-5">
              <div className="mb-9 mb-lg-5">
                <div className="theme-topic">
                  <h1 className="mb-5 fs-3 fs-lg-2 fw-bold ls-1">精選甜點盒</h1>
                ...
                <div className="plan-area">
                  ...
                  <ul className="my-6">
                    <li className="mb-3">
                      <button className="card-plan" type="button">
                        <div className="subtitle">
                          <p>初嚐首選</p>
                          <p className="text-cta-200">節省 $111</p>
                        </div>
                        <div className="title">
                          <p>3個月方案</p>
                          <p className="align-bottom">$720<span>/月</span></p>
                        </div>
                      </button>
                    </li>
                    <li className="mb-3">
                      <button className="card-plan active" type="button">
                        <div className="subtitle">
                          <p>人氣推薦</p>
                          <p className="text-cta-200">節省 $211</p>
                        </div>
                        <div className="title">
                          <p>6個月方案</p>
                          <p className="align-bottom">$700<span>/月</span></p>
                        </div>
                      </button>
                    </li>
                    <li>
                      <button className="card-plan" type="button">
                        <div className="subtitle">
                          <p>鑑賞家專屬</p>
                          <p className="text-cta-200">節省 $311</p>
                        </div>
                        <div className="title">
                          <p>12個月方案</p>
                          <p className="align-bottom">$675<span>/月</span></p>
                        </div>
                      </button>
                    </li>
                  </ul>
                  ...
                  <div className="quantity mb-lg-6">
                    <button className="btn-icon-lg" type="button" aria-label="Decrease" disabled="">
                      <div className="">
                    ...
                    {/* spinner */}
                    <input className="spinner mx-3 fs-7 fw-bold ls-1 border-0 bg-transparent " type="text" role="spinbutton"
                      aria-live="assertive" aria-valuenow="1" value="1" />
                    <button className="btn-icon-lg" type="button" aria-label="Increase">
                      <div className="">
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
                  ...
                  <div className="subscribe-fixed-bar d-flex justify-content-between">
                    <div className="pb-4">
                      <p className="mb-1 fs-9 text-cta-200">節省$211</p>
                      <p className="fs-4 fw-bold ls-1">NT$ 700</p>
                    </div>
                    <div className="pt-3">
                      <button type="button" className="btn-primary-icon align-items-center ls-1 lh-sm">立刻訂閱
  ...
  /> */}
      ...
      <section className="py-lg-11 py-17 bg-neutral-400 position-relative">
        ...
        <div className="container">
          ...
          <nav className="d-lg-block d-none position-relative z-1">
            <ul className="d-flex justify-content-center">
              <li className="custom-page-item active"><a className="custom-page-link" href="#">1</a></li>
              <li className="custom-page-item"><a className="custom-page-link" href="#">2</a></li>
              <li className="custom-page-item"><a className="custom-page-link" href="#">3</a></li>
              <li className="custom-page-item"><a className="custom-page-link" href="#">4</a></li>
              <li className="custom-page-item"><a className="custom-page-link" href="#">5</a></li>
              <li className="custom-page-item"><a className="custom-page-link" href="#"><iconify-icon
                    icon="ri:arrow-drop-right-line" width="24" height="24"></iconify-icon></a>
              </li>
            </ul>
          </nav>
          <nav className="d-block d-lg-none">
            <ul className="d-flex justify-content-center">
              <li className="dropdown custom-page-dropmenu">
                <button type="button" className="custom-page-dropmenu-btn" id="dropdownMenu" data-bs-toggle="dropdown"
                  aria-expanded="false">1
                </button>
                <ul className="dropdown-menu custom-page-dropmenu-panel" aria-labelledby="dropdownMenu">
                  <li><a className="dropdown-item fw-bold noto_sans" href="#">第 1 / 5 頁</a></li>
                  <li><a className="dropdown-item noto_sans" href="#">第1頁</a></li>
                  <li><a className="dropdown-item noto_sans" href="#">第2頁</a></li>
                  <li><a className="dropdown-item noto_sans" href="#">第3頁</a></li>
                  <li><a className="dropdown-item noto_sans" href="#">第4頁</a></li>
                  <li><a className="dropdown-item noto_sans" href="#">第5頁</a></li>
                </ul>
              </li>
              <li className="custom-page-item disabled"><a className="custom-page-link" href="#">/</a></li>
              <li className="custom-page-item disabled"><a className="custom-page-link" href="#">5</a></li>
              <li className="custom-page-item"><a className="custom-page-link" href="#"><iconify-icon
                    icon="ri:arrow-drop-right-line" width="24" height="24"></iconify-icon></a></li>
            </ul>
          </nav>
        </div>
      </section>
